...
#define TEXTURE_ID_RAINBOW 5
#define TEXTURE_ID_FLOOR_2 6
#define TEXTURE_ID_PICTURE 7
#define TEXTURE_ID_DRAGON 8
...
int cur_frame_tiger = 0, cur_frame_ben = 0, cur_frame_wolf, cur_frame_spider = 0, cur_time_spotlight = 0;
...
void prepare_floor(void) { // Draw coordinate axes.
	...
	material_floor.specular_color[0] = 1.24f;
	material_floor.specular_color[1] = 1.5f;
	material_floor.specular_color[2] = 1.24f;
	...
	My_glTexImage2D_from_file("Data/static_objects/diamond.jpg");

	glGenerateMipmap(GL_TEXTURE_2D);

	glActiveTexture(GL_TEXTURE0 + TEXTURE_ID_FLOOR_2);
	glBindTexture(GL_TEXTURE_2D, texture_names[TEXTURE_ID_FLOOR_2]);
	My_glTexImage2D_from_file("Data/static_objects/floor_new.jpg");

	glGenerateMipmap(GL_TEXTURE_2D);

	glActiveTexture(GL_TEXTURE0 + TEXTURE_ID_PICTURE);
	glBindTexture(GL_TEXTURE_2D, texture_names[TEXTURE_ID_PICTURE]);
	My_glTexImage2D_from_file("Data/static_objects/picture.jpg");
...
void prepare_bike(void) {
	...
	glActiveTexture(GL_TEXTURE0 + TEXTURE_ID_RAINBOW);
	glBindTexture(GL_TEXTURE_2D, texture_names[TEXTURE_ID_RAINBOW]);

	My_glTexImage2D_from_file("Data/static_objects/rainbow.jpg");
